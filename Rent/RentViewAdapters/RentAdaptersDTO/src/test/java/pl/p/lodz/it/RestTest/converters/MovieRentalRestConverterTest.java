...
import pl.lodz.p.it.rentviewadapters.converters.MovieRentalConverter;
...
class MovieRentalRestConverterTest {
    ...
    private final ClientDTO accountDTO = new ClientDTO("test", "Testowy", "user", true, "test", "test123");
