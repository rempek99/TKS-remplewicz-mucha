...
import pl.lodz.p.it.viewports.book.*;
import pl.lodz.p.it.viewports.movie.*;
import pl.lodz.p.it.viewports.rentals.*;
...
public class RestEndpoints implements Serializable {
    ...
    public Response getAccFromStorage() {
        return Response
                .ok()
                .entity(getAllAccountsService.getAllAccounts())
    ...
    public Response getSingleAccFromStorage(@PathParam("str") String str) {
        return Response
                .ok()
                .entity(getAccountViaUUIDService.getAccountViaUUID(str))
                .status(Response.Status.OK)
                .build();
    }
    ...
    public Response getMoviesFromStorage() {
        return Response
                .ok()
                .entity(getAllMoviesService.getAllMovies())
                .status(Response.Status.OK)
                .build();
    }
    ...
    // pl.lodz.p.it.viewports.rentals section
