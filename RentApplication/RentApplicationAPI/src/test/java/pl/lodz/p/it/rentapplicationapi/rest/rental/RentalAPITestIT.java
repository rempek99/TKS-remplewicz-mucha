...
import pl.lodz.p.it.rentapplicationapi.rentviewmodel.modelDTO.*;
...
class RentalAPITestIT {
    ...
    private final ClientDTO clientDTO = new ClientDTO("test", "Testowy", "user", true, "test", "test123");
    private final MovieDTO movieDTO = new MovieDTO("Test", "test", 7.9,false);
    private final MovieRentalDTO testMovieRentalDTO = new MovieRentalDTO(movieDTO, clientDTO);
    private final BookDTO bookDTO = new BookDTO("Test", "test", 100,false);
    private final BookRentalDTO testBookRentalDTO = new BookRentalDTO(bookDTO, clientDTO);
